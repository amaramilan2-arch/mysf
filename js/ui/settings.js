...
function updateMacroPreview(){
  ...
  html+='<div style="width:'+pPct+'%;background:#6AEFAF"></div>';
  html+='<div style="width:'+gPct+'%;background:#4DD0E1"></div>';
  html+='<div style="width:'+lPct+'%;background:#FF6B9D"></div></div></div>';
  html+='<div class="sum-row"><div class="sum-box"><div class="sl">Prot</div><div class="sv" style="color:#6AEFAF;font-size:.75rem">'+p+'g <span style="font-size:.55rem;color:var(--t3)">'+pK+' kcal ('+pPct+'%)</span></div></div>';
  html+='<div class="sum-box"><div class="sl">Gluc</div><div class="sv" style="color:#4DD0E1;font-size:.75rem">'+g+'g <span style="font-size:.55rem;color:var(--t3)">'+gK+' kcal ('+gPct+'%)</span></div></div>';
  html+='<div class="sum-box"><div class="sl">Lip</div><div class="sv" style="color:#FF6B9D;font-size:.75rem">'+l+'g <span style="font-size:.55rem;color:var(--t3)">'+lK+' kcal ('+lPct+'%)</span></div></div></div>';
